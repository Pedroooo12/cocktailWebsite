  ...
  listCards: CardFeature[] = [
    {
      ...
      descripion:
        'Encuentra fácilmente tu cocktail favorito ingresando su nombre. Explora recetas, ingredientes y consejos para preparar la bebida perfecta en cualquier ocasión.',
    },
    {
      svg: `<svg class='mr-2 -ml-1 w-5 h-5 group-hover:text-custom-violet' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      descripion:
        'Descubre deliciosos cocktails utilizando los ingredientes que ya tienes. Simplemente ingresa un ingrediente y encuentra recetas creativas para disfrutar.',
    },
    {
      svg: `<svg class='mr-2 -ml-1 w-5 h-5 group-hover:text-custom-violet' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      descripion:
        '¿Listo para probar algo nuevo? Genera un cocktail aleatorio y sorpréndete con recetas inesperadas para disfrutar en cualquier ocasión.',
    },
    {
      svg: `<svg class='mr-2 -ml-1 w-5 h-5 group-hover:text-custom-violet' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      descripion:
        'Descarga la aplicación en tu móvil y accede a todas sus funciones en cualquier momento. Lleva contigo toda la experiencia de forma rápida y sencilla.',
    },
    {
      svg: `<svg class="mr-2 -ml-1 w-5 h-5 group-hover:text-custom-violet" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      descripion:
        'Selecciona tu preferencia y filtra por bebidas alcohólicas. Encuentra los cocktails que contienen tus licores favoritos y disfruta de una experiencia única.',
    },
    {
      svg: `<svg class='mr-2 -ml-1 w-5 h-5 group-hover:text-custom-violet' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      descripion:
        'Personaliza tu búsqueda filtrando por el tipo de vaso. Descubre cocktails ideales para cada presentación y sorprende a tus invitados con estilo.',
    },
  ];
}
